...
$stmt = $conn->prepare("SELECT amount, level, created_at FROM income_history WHERE user_id = ? ORDER BY created_at DESC");
                ...
                <table class="table">
                  ...
                  <tbody class="table-border-bottom-0">
                    <?php foreach ($data as $row): ?>
                      <tr>
                        <td><i class="fas fa-arrow-down text-success me-2"></i><strong>Income</strong></td>
